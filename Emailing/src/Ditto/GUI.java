...
public class GUI extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        jTextArea4.setText(Convert.arrayToString(Encryption.decode(Convert.stringToArray(Ditto.MessageMaker(false, cmdListL).substring(1), "\n"))));
    ...
    class GuiT extends TimerTask {
        ...
        public void run() {
            ArrayList<String> Data;
            Data = Ditto.User.readEmail_simple(Ditto.IDcode);
            if (!Data.isEmpty()) {
